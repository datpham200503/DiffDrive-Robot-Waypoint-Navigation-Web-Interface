...
set(MSG_I_FLAGS "-Idistanceangle:/home/pi/catkin_ws/src/aruco_docking/distanceangle/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pi/catkin_ws/src/aruco_docking/distanceangle/msg/DistanceAngle.msg" NAME_WE)
add_custom_target(_distanceangle_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "distanceangle" "/home/pi/catkin_ws/src/aruco_docking/distanceangle/msg/DistanceAngle.msg" ""
)
...
_generate_msg_cpp(distanceangle
  "/home/pi/catkin_ws/src/aruco_docking/distanceangle/msg/DistanceAngle.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/distanceangle)
  install(CODE "execute_process(COMMAND \"/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/distanceangle\")")
  # install generated code
  install(
