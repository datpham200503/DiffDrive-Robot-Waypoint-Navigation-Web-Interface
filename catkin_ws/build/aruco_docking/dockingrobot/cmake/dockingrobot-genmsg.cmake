...
message(STATUS "dockingrobot: 1 messages, 0 services")

set(MSG_I_FLAGS "-Idockingrobot:/home/pi/catkin_ws/src/aruco_docking/dockingrobot/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pi/catkin_ws/src/aruco_docking/dockingrobot/msg/Docking.msg" NAME_WE)
add_custom_target(_dockingrobot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dockingrobot" "/home/pi/catkin_ws/src/aruco_docking/dockingrobot/msg/Docking.msg" ""
)
...
_generate_msg_cpp(dockingrobot
  "/home/pi/catkin_ws/src/aruco_docking/dockingrobot/msg/Docking.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dockingrobot)
  install(CODE "execute_process(COMMAND \"/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dockingrobot\")")
  # install generated code
  install(
